...
#define MOTOR1A   	REGISTER_BIT(PORTC,0)
#define MOTOR1B    	REGISTER_BIT(PORTC,1)
#define MOTOR2A    	REGISTER_BIT(PORTC,2)
#define MOTOR2B    	REGISTER_BIT(PORTC,3)
#define MOTOR3A   	REGISTER_BIT(PORTC,4)
#define MOTOR3B    	REGISTER_BIT(PORTC,5)
#define MOTOR4A    	REGISTER_BIT(PORTC,6)
#define MOTOR4B    	REGISTER_BIT(PORTC,7)


//MOTOR DIRECTIONS

#define MOTOR1A_DIR   	REGISTER_BIT(DDRC,0)
#define MOTOR1B_DIR     REGISTER_BIT(DDRC,1)
#define MOTOR2A_DIR     REGISTER_BIT(DDRC,2)
#define MOTOR2B_DIR     REGISTER_BIT(DDRC,3)
#define MOTOR3A_DIR   	REGISTER_BIT(DDRC,4)
#define MOTOR3B_DIR     REGISTER_BIT(DDRC,5)
#define MOTOR4A_DIR     REGISTER_BIT(DDRC,6)
#define MOTOR4B_DIR     REGISTER_BIT(DDRC,7)
