...
arr = np.full([g2/g1, g1], 100, np.uint8)
    ...
    if ret == True:
        ...
        for n in range(0,i):
            if n!=1 and n!=2:
                ...
                if n==0:    
                    ret1, track_window = cv2.CamShift(dst[n], (uy[n],ux[n],(vy[n] - uy[n])(vx[n] - ux[n])), term_crit)
                ...
                if noWhitePixel >= 10:
                    cx[n] /= noWhitePixel
                    cy[n] /= noWhitePixel
                    dst[0][cy[0] - 5:cy[0] + 5, cx[0] - 5:cx[0] + 5] = 150
                xc = int((vx[0]-ux[0]+vy[0]-uy[0])/3)
                roi = frame[cy[0]-xc:cy[0]+xc, cx[0]-xc:cx[0]+xc]
                cv2.rectangle(frame, (cx[0]-xc,cy[0]-xc), (cx[0]+xc, cy[0]+xc), (255,255,0),1)
            ...
            if i>=2:
                ...
                if cx22!=cx11 and cx11!=abx:
                    ...
                    cx_3, cy_3 = shift_origin(cx[0], cy[0])
                    ...
                    if cx[0]<abx-20 or cx[0]>abx+20 or cy[0]<aby-20 or cy[0]>aby+2:
